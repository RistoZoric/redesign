 ...
 */	
 ...
 var get_home_url=(element='')=>{
    const set_link=(element)?element+'/':"";
    const homeurl=window.location.origin;
    return homeurl+'/'+set_link;
};
...
KWACHA_MAIN.loadPageData = function (pageNum, config) {
   ...
   let _config          = {},
    ...
    postData = { 'page': page_num,  'perPage': perPage }
...
KWACHA_MAIN.userLogout = function () {
    ...
    console.log('sssssssssss',get_home_url('hsddsfs'));
